...
**상세 기준: `../../shared-references/HIGH_QUALITY_CODE_STANDARDS.md` 참조** — 범용 코드 품질 기준 (필수)
...
- **[HIGH_QUALITY_CODE_STANDARDS.md](../../shared-references/HIGH_QUALITY_CODE_STANDARDS.md)** — 범용 코드 품질 기준 (모든 프로젝트 공통)
