---
description: >
  버그·성능 저하·보안 취약점·아키텍처 문제를 5개 전문 에이전트 팀이 병렬 조사해
  근본 원인을 규명하고 자동 수정까지 완료하는 심층 조사 스킬.
  뭔가 이상하거나, 안 되거나, 느리거나, 원인을 모르는 모든 상황에서 반드시 이 스킬을 사용하라.
  "버그", "에러", "안된다", "느려", "왜 이게", "원인 찾아줘", "조사해줘",
