...
name: tdd
description: >
  테스트를 먼저 작성하고 실패를 확인한 뒤 구현하는 Red-Green-Refactor 사이클을 강제하는 스킬.
  새 기능 구현, 버그 수정, 리팩토링 시 코드 작성 전에 반드시 이 스킬을 사용하라.
  "tdd", "테스트 주도", "테스트 먼저 작성", "테스트 기반으로 구현",
  또는 구현 요청 시 테스트 커버리지가 중요한 경우 트리거.
---
