...
| `/wj:analyze` | `[대상]` | 코드베이스 맥락 분석 — Serena+Context7+Explore로 관련 파일·의존 관계 특정 |
...
| `/wj:analyze` | 코드베이스 맥락 분석 — 수정 전 관련 파일·함수·의존 관계를 Serena+Context7로 정확히 특정 |
