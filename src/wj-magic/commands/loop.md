...
5. **무중단 자율 진행**: task가 남아있으면 사용자에게 묻지 않고 다음 task로 즉시 전진. 게이트 자동 중단 조건에서만 멈춤
...
- 불필요한 리팩토링 금지
- 사용자에게 확인 질문 금지 — 판단이 필요하면 스스로 결정하고 진행
```
...
- ❌ **루프 중간에 사용자에게 확인 질문** — "계속할까요?", "진행할까요?", "먼저 확인해보시겠습니까?" 등 절대 금지. task가 남아있으면 묻지 말고 다음 task로 즉시 전진. 게이트 실패/연속 3회 실패 등 자동 중단 조건에서만 멈춤
