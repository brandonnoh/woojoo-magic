---
name: team
description: 팀 구성, 에이전트, 전문가, 스웜, 병렬 작업, 부서 투입 등의 키워드 시 사용. agents.md 조직도를 참조하여 적절한 전문가 에이전트를 선별하고 TeamCreate + Task 도구로 병렬 팀 작업을 수행. "팀 구성해줘", "에이전트 소환", "전문가 투입", "QA 돌려줘", "보안 점검", "SEO 분석", "성능 최적화", "개발팀 소환", "운영팀 투입" 등의 요청에 트리거.
---
