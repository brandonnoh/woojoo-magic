...
name: ideation
description: >
  PM·UX·사업전략·마케팅·데이터 5명의 전문가 스쿼드를 병렬 투입해 제품 전략을 심층 리서치하는 스킬.
  단순 기획이 아니라 여러 전문가 관점의 분석이 필요할 때 반드시 사용하라.
  "아이데이션", "ideation", "기능 기획해줘", "어떤 방향으로 가야 할까",
  "전략적으로 접근하고 싶어", "시장 분석", "경쟁사 비교", "제품 전략 논의",
  "PM 관점", "UX 관점", "마케팅 전략" 요청에 트리거.
---
